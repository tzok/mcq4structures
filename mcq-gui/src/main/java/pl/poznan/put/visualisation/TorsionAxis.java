...
public final class TorsionAxis extends NumberAxis {
  ...
  public TorsionAxis(
      final List<String> ticksNames, final double ticksRotation, final int fontSize) {
    super();
  ...
  public List<NumberTick> refreshTicks(
    ...
    final List<NumberTick> ticks = super.refreshTicks(g2, state, dataArea, edge);
