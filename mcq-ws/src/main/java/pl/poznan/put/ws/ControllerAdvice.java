...
public class ControllerAdvice {
    ...
    private String illegalArgumentExceptionHandler(IllegalArgumentException illegalArgumentException) {
    ...
    private String NoGitPropertiesExceptionHandler(NoGitPropertiesException noGitPropertiesException) {
    ...
    private String methodArgumentNotValidExceptionHandler(MethodArgumentNotValidException methodArgumentNotValidException) {
