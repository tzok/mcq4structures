...
public class PdbChooser extends JFileChooser {
    ...
    private PdbChooser() {
        super();
        setFileFilter(new FileNameExtensionFilter("Supported formats (PDB, mmCIF)", new String[] { "pdb", "pdb1", "ent", "brk", "cif", "gz" }));
        addChoosableFileFilter(new FileNameExtensionFilter("PDB file format", "pdb", "pdb1", "ent", "brk", "gz"));
