...
public class LocalMultiMatrixPanel extends JPanel {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(LocalMultiMatrixPanel.class);
    ...
    public LocalMultiMatrixPanel() {
        ...
        tabbedPane.add(Messages.getString("results"),
                       new JScrollPane(tableMatrix));
        tabbedPane.add(Messages.getString("histograms"),
                       new JScrollPane(histogramMatrix));
        tabbedPane.add(Messages.getString("percentiles"),
                       new JScrollPane(percentileMatrix));
        tabbedPane.add(Messages.getString("visualization"),
                       new JScrollPane(visualization));
    ...
    public final ProcessingResult compareAndDisplayTable() {
        try {
            ...
            final MasterTorsionAngleType selectedAngleType =
                    selectReferenceTorsionAngleType(reference);
            if (selectedAngleType == null) {
                return ProcessingResult.emptyInstance();
            }

            final LocalComparator mcq =
                    new MCQ(Collections.singletonList(selectedAngleType));
            final ModelsComparisonResult result =
                    mcq.compareModels(reference, fragments);
            ...
            final MultiMatchStatistics statistics = MultiMatchStatistics
                    .calculate(iteratorFactory, selectedAngle);
            ...
            final String message =
                    Messages.getString("failed.to.compare.structures");
    ...
    private PdbCompactFragment selectReferenceStructure() {
        ...
        final Object o = JOptionPane.showInputDialog(this, Messages.getString(
                "select.your.reference.structure"), Messages.getString(
    ...
    private MasterTorsionAngleType selectReferenceTorsionAngleType(
        ...
        switch (moleculeType) {
            case PROTEIN:
                ...
                averageTorsionAngleType =
                        ProteinTorsionAngleType.getAverageOverMainAngles();
                break;
            case RNA:
            ...
            default:
                final String message = MessageFormat
                        .format(Messages.getString("unknown.molecule.type.0"),
                                moleculeType);
        ...
        final Object o = JOptionPane
                .showInputDialog(this, message, title, type, null,
                                 anglesToSelectFrom, averageTorsionAngleType);
