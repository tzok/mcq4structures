      ...
      new AbstractColorMap() {
        private final org.jzy3d.colors.Color identical =
            new org.jzy3d.colors.Color(
                ColorMaps.IDENTICAL.getRed(),
                ColorMaps.IDENTICAL.getGreen(),
                ColorMaps.IDENTICAL.getBlue());
        private final org.jzy3d.colors.Color similar =
            new org.jzy3d.colors.Color(
                ColorMaps.SIMILAR.getRed(),
                ColorMaps.SIMILAR.getGreen(),
                ColorMaps.SIMILAR.getBlue());
        private final org.jzy3d.colors.Color different =
            new org.jzy3d.colors.Color(
                ColorMaps.DIFFERENT.getRed(),
                ColorMaps.DIFFERENT.getGreen(),
                ColorMaps.DIFFERENT.getBlue());
        private final org.jzy3d.colors.Color opposite =
            new org.jzy3d.colors.Color(
                ColorMaps.OPPOSITE.getRed(),
                ColorMaps.OPPOSITE.getGreen(),
                ColorMaps.OPPOSITE.getBlue());
