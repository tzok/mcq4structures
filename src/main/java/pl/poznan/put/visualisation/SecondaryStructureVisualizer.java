...
public final class SecondaryStructureVisualizer {
    ...
    public static SVGDocument visualize(final FragmentMatch fragmentMatch,
                                        final ComparisonMapper mapper) {
        try {
            ...
            final List<MasterTorsionAngleType> angleTypes =
                    fragmentMatch.getAngleTypes();
            final Double[] mapped = mapper.map(residueComparisons, angleTypes);

            final DotBracket dotBracket = SecondaryStructureVisualizer
                    .getTargetDotBracket(fragmentMatch);
    ...
    private static DotBracket getTargetDotBracket(
    ...
    public static SVGDocument visualize(final DotBracket dotBracket,
                                        final Double[] mapped) {
        File tempFile = null;
        ...
        try {
            ...
            return svgDocument;
                ...
                ExceptionNAViewAlgorithm | IOException e) {
            SecondaryStructureVisualizer.LOGGER
