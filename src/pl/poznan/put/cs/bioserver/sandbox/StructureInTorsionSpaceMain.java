...
public class StructureInTorsionSpaceMain {
    public static void main(String[] args) {
         ...
         * 
         * Structure structure =
         * reader.getStructure("/home/tzok/pdb/1EHZ.pdb.gz"); List<Group>
         ...
         * residues);
         * 
         * McqGlobalBean result = ts1.compareGlobally(ts2);
         * System.out.println(result);
         * 
         * for (McqGlobalBean mr : ts1.compareLocally(ts2).getResiduesResults())
